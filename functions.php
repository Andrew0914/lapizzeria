<?php
    ...
    */
    function lapizzeria_styles(){
        ...
        wp_register("fluidbox_css", get_template_directory_uri() ."/css/fluidbox.min.css",array(), '2.0.5');
        ...
        // REGISTRAR LOS  JS
        wp_register_script('fluidbox_js',get_template_directory_uri() . '/js/jquery.fluidbox.min.js', array(), '2.0.5',true);
